...
UnrealProject* ProjectCreationWindow::CreateProject()
{
	...
	DeInitializeWindow();
	if (ui.startProjectCheckBox->isChecked() && project)
...
void ProjectCreationWindow::DeInitializeWindow()
{
	disconnect(ui.projectNameEdit, &QLineEdit::editingFinished, this, &ProjectCreationWindow::OnProjectNameChanged);
	disconnect(ui.selectPathButton, &QPushButton::clicked, this, &ProjectCreationWindow::OnChangePathClicked);
	disconnect(ui.settingsButton, &QPushButton::clicked, this, &ProjectCreationWindow::ChangeProjectSettings);
	disconnect(ui.createButton, &QPushButton::clicked, this, &ProjectCreationWindow::CreateButtonClicked);
	disconnect(ui.managePluginsButton, &QPushButton::clicked, this, &ProjectCreationWindow::OnManagePluginsClicked);
	disconnect(ui.manageModulesButton, &QPushButton::clicked, this, &ProjectCreationWindow::OnManageModulesClicked);
	disconnect(ui.CodeModuleCheckBox, &QCheckBox::stateChanged, this, &ProjectCreationWindow::OnCppModuleCheckBoxStateChanged);
}
